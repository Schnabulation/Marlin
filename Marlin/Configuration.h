...
#define STRING_CONFIG_H_AUTHOR "Steve Heller" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Steves Ender 3 V2"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 98.47 }
